...
class SessionController extends Controller
{
    ...
    public function getProfs($titre_formation)
    {
        try {
            // Récupérez les professeurs en fonction du titre de la formation
            $profsFiltres = Prof::where('specialite', $titre_formation)->get();
    ...
    public function voir($id)
    {
        ...
        $etudiants = Etudiant::where('session', $sessionname)->where('contact', true)->get();
        return view('admin/sessions/voir', ['sessions' => $session, 'etudiants' => $etudiants]);
    }
