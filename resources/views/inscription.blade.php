...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="container animate__animated animate__backInLeft" id="titre-page">
            <div class="row justify-content-center">
                ...
                <div class="col-12" style="text-align: center;">
                    <h1 style="color: black; font-weight:bold; text-transform: uppercase;"><i
                            class="bi bi-card-text icons"></i> Inscription en-ligne</h1>
                </div>
        ...
        <div class="container animate__animated animate__backInLeft" style="padding-top: 10px;">
            <div class="row justify-content-center">
                <div class="col-md-8">
                        ...
                        <div class="card-body">
                            ...
                            <form class="inscription-form" action="{{ url('/inscription/save') }}" method="POST">
                                ...
                                <div class="row espace-inputs">
                                    ...
                                    <div class="col-md-6 form-group" id="email">
                                        ...
                                        <input type="text" name="email"
                                            ...
                                            placeholder="Veuillez saisir votre adresse e-mail ici">
                                ...
                                <div class="row espace-inputs justify-content-center">
                                    ...
                                    <div class="col-md-12">
                                        <hr>
                                        <h5 style="text-align: center"><i class="bi bi-mortarboard-fill"></i> Formation
                                        </h5>
                                        <hr>
                                    </div>
                                ...
                                <div class="row formulaire-btn" style="margin-top:20px;margin-bottom:30px;">
                                    <div class="col-6 form-group">
                                        ...
                                        <button type="button" onclick="sauvegarder()"
                                            class="btn btn-success alpa shadow"><i class="bi bi-check2"></i><span
