...
<main id="main">
  ...
  <section id="ecole" class="ecole">
    ...
    <div class="container mon-div" data-aos="fade-up">
  ...
  <!-- <section id="formations" class="formations">
    ...
    <p class="texte" id="formations-intro">Nous vous offrons les formations suivantes tout en assurant la meilleure qualité des connaissances aquises</p>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="carousel-item-b swiper-slide">
            <div class="card-box-a card-shadow">
              <div class="img-box-a">
                {{-- <img src="{{ asset('storage/'.$formation->photo ) }}" alt="" class="img-a img-fluid"> --}}
              </div>
              <div class="card-overlay">
                <div class="card-overlay-a-content">
                  <div class="card-header-a">
                    <h2 class="card-title-a">
                      {{-- <a href="property-single.html"> {{ $formation->titre }} </a> --}}
                    </h2>
                  </div>
                  <div class="card-body-a">
                    ...
                    <a href="#" class="link-a">Inscription à cette formation<span class="bi bi-chevron-right"></span>
                    </a>
                  </div>
...
{{--
        ...
        <div class="col-md-12">
          <div class="title-wrap d-flex justify-content-between">
            ...
            <div class="title-link">
              ...
              <a href="{{ url('/formations')}}" class="s-titre">Voir Tout<span class="bi bi-chevron-right"></span></a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="carousel-item-c swiper-slide">
            <div class="card-box-b card-shadow news-box">
              <div class="img-box-b">
                <img src="{{ asset('storage/'.$formation->photo ) }}" alt="image-formation" class="img-b img-fluid">
              </div>
              <div class="card-overlay">
                <div class="card-header-b">
                  ...
                  <div class="div-boutton">
                    <a href="{{ url('/inscription/'.$formation->id )}}" class="btn-inscription">Inscription</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="testimonial-item">
              ...
              <img src="{{'storage/'.$temoignage->photo}}" class="testimonial-img" alt="">
  ...
  <section id="faq" class="faq section-bg">
    ...
    <div class="container mon-div" data-aos="fade-up">
      ...
      <ul class="faq-list">
        ...
        <li>
          <div data-bs-toggle="collapse" class="collapsed question" href="{{'#faq'.$question->id}}">{{ $question->question }}<i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
  ...
  <section id="contact" class="contact">
    ...
    <div class="container-fluid" style="text-align: center;">
      <iframe style="border:0; width: 100%; height: 350px;" src="{{$informations->localisation}}" frameborder="0" allowfullscreen></iframe>
    </div>
    ...
    <div class="container">
      ...
      <div class="row mt-5">
        ...
        <div class="col-lg-6" style="background-color: #ffff;">
          ...
          <div class="row">
            ...
            <div class="col-md-6" data-aos="flip-right">
              <div class="info-box mt-4">
                ...
                <p>{{$telephone->operateur}} : <a href="">{{$telephone->numero}}</a></p> <br>
                @endforeach
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-6" data-aos="flip-left" style="background-color: #ffff;">

          <form action="{{url('/message')}}" method="post" class="email-form">
            @csrf
            <div class="row">

              <div class="col-lg-12 col-md-12 titre-message">
                <h6>Contactez-nous par message</h6>
              </div>
              ...
              <div class="col form-group">
                <input type="text" class="form-control" name="tel" id="tel" placeholder="Votre n° de téléphone" required>
              </div>
              ...
              <div class="form-group" style="margin-top: 10px;">
                <input type="submit" class="form-control btn btn-success" value="Envoyer le message">
              </div>
          </form>
        </div>
