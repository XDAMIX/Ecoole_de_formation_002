    ...
    <div class="container" id="titre-page">
        <div class="row">
            ...
            <div class="col-10 d-flex align-items-center">
                <h2>Ajouter une nouvelle partie de présentation</h2>
            </div>
        </div>
    </div>
                ...
                <div class="card shadow" style="background-color: #ffff;">
                  ...
                  <a style="font-size: 20px;">Nouveau bloc de présentation</a>
                    ...
                    <div class="card-body">
                        ...
                        <form class="add-form" action="{{ url('/admin/ecole/presentation/save') }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="titre"
                                    ...
                                    id="validationServer01" placeholder="le titre" value="{{ old('titre') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="sous_titre"
                                    ...
                                    id="validationServer02" placeholder="le sous titre" value="{{ old('sous_titre') }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" name="paragraphe" class="form-control @if ($errors->get('paragraphe')) is-invalid @endif"
                                    id="validationServer03" placeholder="le paragraphe" value="">{{ old('paragraphe') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-12" style="text-align: center;">
                                    <img src="" class="img-fluid rounded" alt=""
                                        style="width:100%; margin-top: 15px;margin-bottom: 15px;" id="preview">
                                </div>
    ...
    <script>
        function sauvegarder(button) {
            ...
            if (form) {
                ...
                Swal.fire({
                    title: "Êtes-vous sûr(e) de vouloir enregistrer cette Partie de présentation ?",
                    text: name,
                    icon: "question",
