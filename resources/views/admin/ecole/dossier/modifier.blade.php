        ...
        <div class="row animate__animated animate__backInLeft">
            <div class="col-md-12">
                <div class="card shadow" style="background-color: #ffff;">
                    ...
                    <div class="card-body">
                        <form class="edit-form" action="{{ url('/admin/dossier/' . $dossier->id . '/update') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="titre"
                                    ...
                                    id="ValidationTitre" placeholder="le titre" value="{{ $dossier->titre }}" required>
                            ...
                            <div class="form-group row justify-content-center text-center">
                                ...
                                <div class="col-6">
                                    <a class="btn btn-outline-danger alpa shadow" href="{{ '/admin/dossier' }}"><i
