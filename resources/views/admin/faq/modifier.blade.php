    ...
    <div class="container" id="titre-page">
        <div class="row">
            ...
            <div class="col-8  text-center">
                <h2>Modifier la Question / Réponse</h2>
            </div>
        </div>
    </div>
                ...
                <div class="card shadow" style="background-color: #ffff;">
                  ...
                  <a style="font-size: 20px;">Nouveau bloc de présentation</a>
                    ...
                    <div class="card-body">
                        ...
                        <form class="edit-form" action="{{ url('/admin/faq/'.$question->id.'/update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" name="question" class="form-control @if ($errors->get('question')) is-invalid @endif"
                                    id="validationQuestion" placeholder="la question" value="" required>{{ $question->question }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" name="reponse" class="form-control @if ($errors->get('reponse')) is-invalid @endif"
                                    id="validationReponse" placeholder="le réponse" value="" required>{{ $question->reponse }}</textarea>
        ...
        <script>
            function sauvegarder(button) {
                ...
                if (form) {
                    ...
                    Swal.fire({
                        title: "Êtes-vous sûr(e) de vouloir enregistrer les modifications pour cette Question/Réponse?",
                        text: name,
                        icon: "question",
