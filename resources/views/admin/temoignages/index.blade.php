    ...
    <div class="container" id="titre-page">
        <div class="row">
            ...
            <div class="col-2 d-flex align-items-center pl-5">
                <a href="{{ url('/admin/temoignages/nouveau') }}" class="btn btn-success"><i
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 mb-3 mb-sm-0 text-center">
                                    ...
                                    <div class="truncate-text" id="truncate-text{{ $temoignage->id }}">
                                        <p class="card-title" id="texte{{ $temoignage->id }}">
                                            <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                            {{ $temoignage->mot }}
                                            <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                        </p>
                                        {{-- expand button  --}}
                                        <button id="truncate-button{{ $temoignage->id }}" class="btn btn-light"
                                            onclick="toggleText({{ $temoignage->id }})">voir plus</button>
