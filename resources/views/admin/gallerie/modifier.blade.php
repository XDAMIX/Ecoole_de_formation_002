        ...
        <div class="row animate__animated animate__backInLeft">
            ...
            <div class="card shadow col-12">
                ...
                <div class="card-body col-12">
                    ...
                    <form class="edit-form" action="{{ url('/admin/gallerie/' . $photo->id . '/update') }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 gauche">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="emplacement" class="form-control" placeholder="emplacement"
                                        value="{{ $photo->emplacement }}" required>
                                </div>


                                <div class="form-group">
                                    <label for="dure">Durée :</label>
                                    <input type="text" name="dure" class="form-control" placeholder="dure"
                                        value="{{ $photo->dure }}" required>
                                </div>


                                <div class="form-group">
                                    <label for="description">Description :</label>
                                    <textarea name="description" class="form-control" placeholder="description" required>{{ $photo->description }}</textarea>
                                </div>
                            ...
                            <div class="col-12 col-md-6 droite" id="imagePreview"
                                style="background-image: url({{ asset('storage/' . $photo->photo) }} );background-size: cover;background-position: center;background-repeat: no-repeat;  height:500px;">
    ...
    <script>
        function sauvegarder(button) {
            ...
            if (form) {
                ...
                Swal.fire({
                    title: "Êtes-vous sûr(e) de vouloir enregistrer les modifications de cette actualité ?",
                    text: name,
                    icon: "question",
