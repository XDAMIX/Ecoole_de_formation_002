...
<div class="container" style="margin-top: 10px;" >
        ...
        <div class="card" style="background-color: #ffff;">
                <div class="card-header"style="text-align:center;">
                  <!-- <a style="font-size: 20px;"><i class="bi bi-person"></i>Modifier les informations de la Formation</a> -->
                    <h1>Ajouter une nouvelle Actualites <i class="fa-solid fa-file-pen"></i></h1>
                </div>
                <div class="card-body" >
                <form action="{{ url('/admin/gallerie/save') }}" method="POST"  id="enr-form" enctype="multipart/form-data">
                @csrf
    ...
    <div class="container-group">
        ...
        <div class="input-div" >
            ...
            <div class="form__group field" >
                <input required="" placeholder="titre" name="titre" class="form__field @if($errors->get('titre')) is-invalid @endif" type="text" value="{{ old('titre') }}" id="validationServer01">
            ...
            <div class="form__group field" >
                <input required="" placeholder="titre" name="emplacement" class="form__field @if($errors->get('emplacement')) is-invalid @endif" type="text" value="" id="validationServer02">
              ...
              <div class="form__group field">
                     <input required="" placeholder="Duré" name="dure" class="form__field @if($errors->get('dure')) is-invalid @endif" type="text" value="" id="validationServer03">
 ...
 <div class="photo-div" style="margin-top : 10px;">
        ...
        <div class="card col-xs-12 col-sm-6 col-md-3 col-lg-12" id="uploadphoto" style="margin-left: 5px; height: 100%;">
          <img src="" style="padding: 2%; height: 300px;" id="imagePreview" class="card-img-top" alt="...">
          <div class="card-body">
...
//    bouton annuler
        ...
        boutonanl.addEventListener("click",function(){
                                                ...
                                                boutonsave.addEventListener('click',function(){
                                                    Swal.fire({
                                                                title: 'Voulez-vous enregistrer cette Actualite ',
                                                                showDenyButton: true,
                                                                showCancelButton: true,
