        ...
        <div class="row animate__animated animate__backInLeft">
            ...
            <h5>Nouvelle Publicité :</h5>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('/admin/gallerie/save') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="titre">Titre de l'actualité :</label>
                            <input name="titre" type="text" placeholder="titre"
                                class="form-control @if ($errors->get('titre')) is-invalid @endif" required id="validationTitre">
                        ...
                        <div class="form-group">
                            ...
                            <input name="emplacement" type="text" placeholder="emplacement"
                        ...
                        <div class="form-group">
                            ...
                            <input name="dure" type="text" placeholder="dure"
                                class="form-control" required>
                        </div>
