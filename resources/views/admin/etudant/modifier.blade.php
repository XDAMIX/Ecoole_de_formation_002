...
{{-- ---------------------------------------------------------- --}}
            ...
            <div class="col-md-12">
                ...
                <a style="font-size: 20px;">Formulaire d'inscription</a>
                    ...
                    <div class="card-body">
                        ...
                        <form class="edit-form" action="{{ url('/admin/etudiant/'.$etudiant->id.'/update') }}" method="POST">
                          @csrf
                          @method('PUT')
                            ...
                            <div class="row espace-inputs">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" name="nom"
                                        ...
                                        id="validationServer01" placeholder="Veuillez saisir votre nom ici" value="{{ $etudiant->nom }}" >
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" name="prenom"
                                        ...
                                        id="validationServer02" placeholder="Veuillez saisir votre prénom ici" value="{{ $etudiant->prenom }}">
                            ...
                            <div class="row espace-inputs">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="number" name="age"
                                        ...
                                        id="validationServer03" placeholder="" min="18"  value="{{ $etudiant->age }}">
                                ...
                                <div class="col-md-8 form-group">
                                    ...
                                    <select class="form-control" name="wilaya">
                                      ...
                                      <option value="{{ $etudiant->wilaya }}" style="display:none;" selected>
                            ...
                            <div class="row espace-inputs">
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <input type="text" name="profession"
                                        ...
                                        id="validationServer04" placeholder="Veuillez saisir votre profession ici" value="{{ $etudiant->profession }}">
                            ...
                            <div class="row espace-inputs">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" name="tel"
                                        ...
                                        placeholder="Veuillez saisir votre numéro de téléphone ici" value="{{ $etudiant->tel }}">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" name="email"
                                        ...
                                        id="validationServer06" placeholder="Veuillez saisir votre adresse e-mail ici" value="{{ $etudiant->email }}">
                              ...
                              <div class="col-md-12">
                                ...
                                <div class="col-md-4 form-group" style="text-align: center;">
                                    ...
                                    <select class="form-control" name="formation" id="formation" >
                                      <option value="{{ $etudiant->formation }}" style="display:none;" selected>
                                        {{ $etudiant->formation }}</option>
                                ...
                                <div class="col-md-4 form-group" style="text-align: center;">
                                    ...
                                    <select class="form-control" name="session" id="session" >
                                      <option value="{{ $etudiant->session }}" style="display:none;" selected>
                                        {{ $etudiant->session }}</option>
                                        {{-- liste des sessions selon la formation --}}
                                    </select>
                                </div>

                                <div class="col-md-4 form-group" id="montant" style="text-align: center;">
                                  <label for="">Paiement :</label>

                                  <input type="text" name="montant"
                                      class="form-control @if ($errors->get('montant')) is-invalid @endif"
                                      id="validationServer07" placeholder="Veuillez saisir le montant d'argent encaissé"  value="{{ $etudiant->montant }}">
  ...
  <script>
    ...
    function filtrerSessions() {
        ...
        $.ajax({
            url: '/get-sessions/' + titreFormation,
            type: 'GET',
            headers: {
            ...
            success: function (response) {
                ...
                $.each(response.sessions, function (key, value) {
                    $('#session').append('<option value="' + value.nom + '">' + value.nom + '</option>');
                });
            },
