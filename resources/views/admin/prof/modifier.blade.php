                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-4 form-group" id="nom">
                                                        ...
                                                        <input type="text" name="nom"
                                                            ...
                                                            id="validationNom" placeholder="Veuillez saisir le nom ici" value="{{ $prof->nom }}">
                                                    ...
                                                    <div class="col-12 col-md-4 form-group" id="prenom">
                                                        ...
                                                        <input type="text" name="prenom"
                                                            ...
                                                            id="validationPrenom"
                                                            placeholder="Veuillez saisir le prénom ici" value={{ $prof->prenom }}>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-4 form-group" id="date_naissance">
                                                        ...
                                                        <input type="date" name="date_naissance"
                                                            ...
                                                            id="validationDate" value={{ $prof->date_naissance }}>
                                                    ...
                                                    <div class="col-12 col-md-8 form-group" id="lieu_naissance">
                                                        ...
                                                        <input type="text" name="lieu_naissance"
                                                            ...
                                                            id="validationLieu"
                                                            placeholder="Veuillez saisir le lieu de naissance ici" value={{ $prof->lieu_naissance }}>
                                                    ...
                                                    <div class="col-12 col-md-4 form-group" id="wilaya">
                                                        ...
                                                        <select class="form-control form-select" name="wilaya">
                                                            <option value="{{ $prof->wilaya }}" style="display:none;"
                                                                selected>
                                                                {{ $prof->wilaya }}</option>
                                                    ...
                                                    <div class="col-12 col-md-8 form-group" id="adresse">
                                                        ...
                                                        <input type="text" name="adresse"
                                                            ...
                                                            placeholder="Veuillez saisir l'adresse ici" value="{{ $prof->adresse }}">
                                                    ...
                                                    <div class="col-12 col-md-6 form-group" id="tel">
                                                        ...
                                                        <input type="text" name="tel"
                                                            ...
                                                            id="validationTel"
                                                            placeholder="Veuillez saisir le numéro de téléphone ici" value="{{ $prof->tel }}">
                                                    ...
                                                    <div class="col-12 col-md-6 form-group" id="email">
                                                        ...
                                                        <input type="text" name="email"
                                                            ...
                                                            id="validationEmail"
                                                            placeholder="Veuillez saisir le email ici" value="{{ $prof->email }}">
                                                    ...
                                                    <div class="col-12 col-md-12 form-group" id="diplome">
                                                        ...
                                                        <input type="text" name="diplome"
                                                            ...
                                                            placeholder="Veuillez saisir le diplome ici" value="{{ $prof->diplome }}">
                                    ...
                                    <div class="col-12" style="padding-top: 10px;">
                                        <table class="table table-bordered" style="width:100%">
                                            ...
                                            <tbody id="cours">
                                                ...
                                                <td>{{ $cour->titre_formation }}</td>
                                                <td>
                                                <form class="delete-form" action="" data-id="{{ $cour->id_cour }}" method="POST">
                                                @csrf
                                                @method("DELETE")
