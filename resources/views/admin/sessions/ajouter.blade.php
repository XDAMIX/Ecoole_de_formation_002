...
<div class="divepo">
{{-- new style --}}
<form class="form" action="{{ url('/admin/session/save') }}" id="enr-form" method="POST" enctype="multipart/form-data">
    <h1 class="title">ajouter une nouvelle session</h1>
    ...
    <div class="divepo">
        <input type="text" class="input" id="nom" name="nom" value="" required>
    </div>
    <br>
    ...
    <div class="col form-group">
        <select class="form-control" style="text-align: center;font-size: 15px;font-weight: bold" name="formation">
            <option style="color: white;background-color: #515969" value="" ></option>
