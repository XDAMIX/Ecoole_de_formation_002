...
<div class="container" style="padding-top: 100px;">
    ...
    <div class="head">
        <h3 style="text-transform: uppercase;">{{ $formation->titre }}</h3>
    </div>

    {{-- a ajouter un PDF pour la formation  --}}
    {{-- <div class="d-grid gap-1 d-md-flex justify-content-md-end" style="margin-top: 10px;margin-bottom: 10px;">
        <button class="button-add-new s-titre" onclick="window.location.href='/admin/formation/nouveau';">Telecharger catalogue des formations  :<i class="fa-sharp fa-solid fa-file-circle-plus hichem"></i></button>
    </div> --}}


        <div class="row ">
                        
                    <div class="flip-card col-lg-4 col-md-6 col-sm-12 col-xs-12">
             ...
             <div style="text-align: center;">
              ...
              <script>
                                            ...
                                            //    <!-- script pour le button inscription  -->
                                               ...
                                               boutonmdf.addEventListener("click",function(){
                                                    ...
                                                    swalWithBootstrapButtons.fire({
                                                        title: 'Inscription ',
                                                        text: "Voulez-vous faire une inscription ....: {{ $formation->titre }}",
                                                        icon: 'warning',
                                                        ...
                                                        if (result.isConfirmed) {
                                                            window.location.href="{{ url('/inscription/'.$formation->id )}}"
