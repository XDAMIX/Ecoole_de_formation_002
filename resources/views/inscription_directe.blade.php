...
<form class="form" id="form_insc" action="{{url('/inscription/save')}}" method="POST">
@csrf
...
{{--  nom et prenom --}}
      <label>
        <input class="input" id="nom" type="text" name="nom" placeholder="" required="">
        <span>Nom</span>
    </label> 
      <label>
        <input class="input" id="prenom" type="text" name="prenom" placeholder="" required="">
        <span>Prénom</span>
    </label> 
   {{-- fin nom et prenom  --}}
   {{-- age --}}
         <label>
        <input class="input"  name="age" id="age" type="number" placeholder="" required="">
        <span>Votre âge</span>
    </label> 
    {{-- fin age--}}
    {{-- wilaya --}}
    ...
    <label>
      <input class="input"  name="profession" id="profession" type="text" placeholder="" required="">
...
{{-- telephone --}}
    <label>
      <input class="input" id="tel" type="tel" name="tel" placeholder="" required="">
