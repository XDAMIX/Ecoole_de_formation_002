        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-xl-11 d-flex align-items-center justify-content-between">
                    <a class="logo me-auto" data-bs-toggle="offcanvas" href="#offcanvasWithBothOptions" role="button"
                        aria-controls="offcanvasWithBothOptions">
                        <img class="animate__animated animate__slideInDown"
                            src="{{ asset('storage/' . $informations->logo_blanc) }}" alt="logo">
                    </a>
                                ...
                                <div class="row espace">
                                    ...
                                    <div class="col-md-12">
                                        <div class="info-box mt-4">
                                            ...
                                            <h3>Email</h3>
                                            <p><a
                                                    href="mailto:{{ $informations->email }}">{{ $informations->email }}</a>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                            ...
                            <li>
                                ...
                                <div class="btn-conteiner animate__animated animate__rubberBand">
                                    <a class="btn-content" href="{{ '/inscription/nouveau' }}">
                                        <span class="btn-title" style="font-size: 20px;"><i class="bi bi-mortarboard"
                                                style="margin-right:5px;font-size: 22px;"></i> INSCRIPTION</span>
        ...
        <div id="heroCarousel" data-bs-interval="3000" class="carousel slide carousel-fade" data-bs-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active"
                    style="background-image: url( {{ asset('storage/' . $acceuil->photo) }} );">
                    <div class="carousel-container">
                        <div class="container">
                            <img src="{{ asset('storage/' . $informations->logo_blanc) }}" alt="logo"
                                class="img-fluid" style="height: 200px;padding:30px;">
                ...
                @foreach ($banners as $banner)
                    <div class="carousel-item" data-aos="flip-up"
